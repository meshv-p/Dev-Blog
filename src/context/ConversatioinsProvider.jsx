...
export const ConversatioinsProvider = ({ children }) => {
    ...
    return (
        <ConversationsContext.Provider value={{ unread, setUnread, onlineU, setOnlineU, selectedUser, setSelectedUser, messages, setMessages, selectedUserData, setSelectedUserData }}>
            {children}
