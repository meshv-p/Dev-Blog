...
const CreateBlog = () => {
    ...
    let { id } = history.query

    useEffect(() => {
        console.log(editBlog, 'his');
    }, [])
    ...
    const blogUpdate = async () => {
        ...
        let res;
        try {
            res = await fetch(`${URL}/api/v1/blog/${editBlog._id}`, {
                method: 'PATCH',
        ...
        <>
            ...
            <Container sx={{ px: 0 }}>
                ...
                <Card sx={{ m: 1, p: 1 }}>
                    ...
                    <Typography textAlign='center' variant='h5' sx={{ my: 2 }} color="text.secondary">Update a
                        blog...</Typography>
                    ...
                    <Stack gap={3}>
                        ...
                        <Button variant="contained" onClick={blogUpdate}>Update blog</Button>
